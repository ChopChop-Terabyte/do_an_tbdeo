...
namespace peripherals {
    ...
    I2CDriver::I2CDriver(i2c_port_num_t i2c_port_num, gpio_num_t sda_pin, gpio_num_t scl_pin)
    ...
    void I2CDriver::remove_dev(i2c_master_dev_handle_t dev_handle) {
        ESP_ERROR_CHECK(i2c_master_bus_rm_device(dev_handle));
    }

    void I2CDriver::write_bytes(i2c_master_dev_handle_t dev_handle, uint8_t *write_buf, size_t write_size) {
        i2c_master_transmit(dev_handle, write_buf, write_size, -1);
    }

    void I2CDriver::read_bytes(i2c_master_dev_handle_t dev_handle, uint8_t *read_buf, size_t read_size) {
        i2c_master_receive(dev_handle, read_buf, read_size, -1);
    }

    void I2CDriver::write_read(i2c_master_dev_handle_t dev_handle, uint8_t *write_buf, size_t write_size, uint8_t *read_buf, size_t read_size) {
